...
path = f'/disco/share/sh1293/Emily_data'
print('opening data')
data = xr.open_dataset(f'{path}/EMARS_Ls0-360_350K.nc').astype('float32')
...
d = d1.where(d1.lat>=45, drop=True)
d['PV_lait'] = d.PV * (d.ilev/200)**(-5)*10**4
print('taking mean')
d = d.PV_lait
d_mean = d.mean('time')
d_inst = d[0,:,:]
