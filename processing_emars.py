...
for type in ['Control/', 'Analaysis/']

    epath = '/disco/share/sh1293/EMARS_data/' + type + 'Raw/'
    print('opening data')
    initds = xr.open_mfdataset(opath + 'emars*.nc')
    ...
    for year in years:
        ...
        d_isobaric.to_netcdf('/disco/share/sh1293/EMARS_data/%sIsobaric/isobaric_openmars_my%.0f.nc' %(type, year))
        ...
        d_isentropic.to_netcdf('/disco/share/sh1293/EMARS_data/%sIsentropic/isentropic_openmars_my%.0f.nc' %(year))
