...
for timeind in range(1000, 1002):
    ...
    cf = ds1.co2diff[timeind,:,:].plot.contourf(ax=ax, transform=ccrs.PlateCarree(), cmap='OrRd', vmin=-20, vmax=20,
    ...
    plt.savefig(f'{root_path}/{directory}/CO2_ice/Plots/stereo_cond/stereo_condloc_{level}K_my{year}_Ls{Lsint}-{Lsdec}.pdf')
