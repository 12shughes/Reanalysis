...
fcs.eddy_enstrophy_contourf_plot(path, years, scaled='yes3')
...
fcs.eddy_enstrophy_climatology_plot(path, years, scaled='yes3')
if datachoice == 'o':
    fcs.eddy_enstrophy_climatology_plot(path, years, scaled='yes2exc')
    fcs.eddy_enstrophy_climatology_plot(path, years, scaled='yes3exc')
...
fcs.eddy_enstrophy_time_series(path, years, islev, scaled='yes3')
