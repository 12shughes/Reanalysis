...
if __name__ == "__main__":
    ...
    #constants that are probably defined elsehwere in Emily's code
    omega = 7.08822e-05
    g = 3.72076
    rsphere = 3.3962e6
    
    inpath = '/disco/share/sh1293/OpenMars_data/'
    ...
    for f in infiles:
        print(f)
    os.chdir(home)
    isenpath = '/disco/share/sh1293/OpenMars_data/Isentropic/'
    isopath = '/disco/share/sh1293/OpenMars_data/Isobaric/'
    #inpath = ''
    #outpath = 'MACDA_data/'
    #figpath = '~/Reanalysis'
    ...
    for f in infiles:
        if not exists(isenpath + 'isentropic_' + f) or not exists(isopath + 'isobaric_' + f):
            ...
            thta = PV.potential_temperature(d.temp, prs,
                                                kappa = kappa, p0 = p0)
